...
namespace xor_strs
{
	...
	extern std::string aa_pitch_random;
	extern std::string aa_pitch_jitter;
	extern std::string aa_pitch_custom;
	...
	extern std::string aa_jitter_skitter;
	...
	extern std::string target_lowest_health;
	extern std::string target_cycle;
	extern std::string target_cycle_2x;
	extern std::string target_best_hitchance;
