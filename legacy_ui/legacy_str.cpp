...
namespace xor_strs
{
	...
	std::string aa_pitch_random{};
	std::string aa_pitch_jitter{};
	std::string aa_pitch_custom{};
	...
	std::string target_lowest_health{};
	std::string target_cycle;
	std::string target_cycle_2x;
	std::string target_best_hitchance;
	...
	__forceinline void init()
	{
		...
		aa_pitch_up = XOR("Up");
		aa_pitch_random = XOR("Random");
		aa_pitch_jitter = XOR("Jitter");
		aa_pitch_custom = XOR("Custom");
		...
		target_lowest_health = XOR("Lowest Health");
		target_cycle = XOR("Cycle");
		target_cycle_2x = XOR("Cycle(2x)");
		target_best_hitchance = XOR("Best hitchance");
