	...
	void create(const std::string& config_name)
	{
		...
		//	save_bool(antihit, CXOR("silent_onshot"), default_config.antihit.silent_onshot);
			...
			save_bool(antihit, CXOR("fakelag"), default_config.antihit.fakelag);
                        ...
                        save_bool(antihit, CXOR("flick_head"), default_config.antihit.flick_head);
                        save_bool(antihit, CXOR("constant_flick"), default_config.antihit.constant_flick);
                        save_int(antihit, CXOR("flick_add"), default_config.antihit.flick_add);
                        save_int(antihit, CXOR("flick_speed"), default_config.antihit.flick_speed);
			...
			save_bool(antihit, CXOR("random_delay"), default_config.antihit.random_delay);
			...
			save_int(antihit, CXOR("jitter_delay"), default_config.antihit.jitter_delay);
		...
		auto& misc = json_obj[CXOR("misc")];
		{
			...
			save_bool(misc, CXOR("compensate_throwable"), default_config.misc.compensate_throwable);
	...
	void save(const std::string& config_name)
	{
		...
		auto& antihit = json_obj[CXOR("antihit")];
		{
			...
			save_bool(antihit, CXOR("fakelag"), g_cfg.antihit.fakelag);
                        ...
                        save_bool(antihit, CXOR("flick_head"), g_cfg.antihit.flick_head);
                        save_bool(antihit, CXOR("constant_flick"), g_cfg.antihit.constant_flick);
                        save_int(antihit, CXOR("flick_add"), g_cfg.antihit.flick_add);
                        save_int(antihit, CXOR("flick_speed"), g_cfg.antihit.flick_speed);
			...
			save_bool(antihit, CXOR("random_delay"), g_cfg.antihit.random_delay);
			...
			save_int(antihit, CXOR("jitter_delay"), g_cfg.antihit.jitter_delay);
		...
		auto& misc = json_obj[CXOR("misc")];
		{
			...
			save_bool(misc, CXOR("compensate_throwable"), g_cfg.misc.compensate_throwable);
	...
	void load(const std::string& config_name)
	{
		...
		//	load_bool(antihit, CXOR("silent_onshot"), g_cfg.antihit.silent_onshot);
			...
			load_bool(antihit, CXOR("fakelag"), g_cfg.antihit.fakelag);
                        ...
                        load_bool(antihit, CXOR("flick_head"), g_cfg.antihit.flick_head);
                        load_bool(antihit, CXOR("constant_flick"), g_cfg.antihit.constant_flick);
                        load_int(antihit, CXOR("flick_add"), g_cfg.antihit.flick_add);
                        load_int(antihit, CXOR("flick_speed"), g_cfg.antihit.flick_speed);
			...
			load_bool(antihit, CXOR("random_delay"), g_cfg.antihit.random_delay);
			...
			load_int(antihit, CXOR("jitter_delay"), g_cfg.antihit.jitter_delay);
		...
		auto& misc = json_obj[CXOR("misc")];
		{
			...
			load_bool(misc, CXOR("fast_stop"), g_cfg.misc.fast_stop);
						...
						load_bool(misc, CXOR("compensate_throwable"), g_cfg.misc.compensate_throwable);
